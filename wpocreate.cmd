...
IF nargs\=4 | wpclass="" | name="" THEN DO; parse source os what me
  say filespec('name',me) '"<objecthandle>" class directory/^<WP_DESKTOP^> "description"'; exit 0; END;
...
IF \ DirectoryExists(dir) & SubStr(dir,1,1)!='<' THEN DO; Say 'directory "'dir'" not found.'; exit 2; END;
